...
export const generateContent = async (req: Request, res: Response) => {
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      max_tokens: 4000, // Increase the token limit for longer outputs
    });
