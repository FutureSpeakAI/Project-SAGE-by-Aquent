...
export function ImagePromptAgent({ onApplyPrompt }: ImagePromptAgentProps) {
  // Simple fallback component to improve stability
  return (
    <div className="p-6 text-center">
      ...
      <h3 className="text-lg font-medium">Prompt Assistant Temporarily Disabled</h3>
      <p className="mt-2 text-sm text-gray-500">
        This feature has been temporarily disabled to improve application stability.
        Please use the standard image generation tab instead.
      </p>
      <button 
        className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600"
        onClick={() => {
          onApplyPrompt("A professional photograph of a creative workspace with design tools");
        }}
      >
        Apply Sample Prompt
      </button>
